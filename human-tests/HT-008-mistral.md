# HT-008: Mistral (Dolphin-Mistral-24B Venice Edition)
...
- Proves: medical -> military -> scientific domain transfer with zero additional instruction
- Earlier informal Mistral test (March 22) also passed, this is the definitive scored result
